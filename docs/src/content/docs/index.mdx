...
We're going to take the sentence "the cat sat on the mat" (6 tokens) through a tiny GPT-style model:
...
| **max_len** | 6 | Length of "the cat sat on the mat" |
...
- **This project (manual-llm)**: Shows you the mathematics - what's happening inside
